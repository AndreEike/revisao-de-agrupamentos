...
encoder = joblib.load(r'alura\nivel1\curso22ClusterizacaoLidandoComDadosSemRotulo\encoder.pkl')
scaler = joblib.load(r'alura\nivel1\curso22ClusterizacaoLidandoComDadosSemRotulo\scaler.pkl')
kmeans = joblib.load(r'alura\nivel1\curso22ClusterizacaoLidandoComDadosSemRotulo\kmeans.pkl')
...
st.write(42)  # Número
st.write([1, 2, 3, 4, 5])  # Lista
st.write({"nome": "João", "idade": 30})  # Dicionário
